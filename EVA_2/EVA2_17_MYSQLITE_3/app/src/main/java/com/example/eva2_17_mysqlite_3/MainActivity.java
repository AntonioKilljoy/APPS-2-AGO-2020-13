...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cvDatos.put("nombre", "BENJAMIN");
        cvDatos.put("apellido", "VAZQUEZ ZAVALA");
        sqlDB.insert("mitabla", null, cvDatos);
        cvDatos.clear();
        cvDatos.put("nombre", "ANTONIO");
        cvDatos.put("apellido", "ZAVALA");
        sqlDB.insert("mitabla", null, cvDatos);
        cvDatos.clear();
        cvDatos.put("nombre", "JUAN");
        cvDatos.put("apellido", "LOPEZ PEREZ");
        sqlDB.insert("mitabla", null, cvDatos);
        cvDatos.clear();
        long iClave;
        cvDatos.put("nombre", "MARIO");
        cvDatos.put("apellido", "MORALES");
        iClave = sqlDB.insert("mitabla", null, cvDatos);
        Toast.makeText(this, iClave + "", Toast.LENGTH_LONG).show();

        //UPDATE
        cvDatos.clear();
        cvDatos.put("nombre", "ANTONELA");
        String[] args={iClave + ""};
